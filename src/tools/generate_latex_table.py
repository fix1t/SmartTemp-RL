"""
    File: generate_latex_table.py
    Author: Gabriel Biel

    Description: Module to generate a LaTeX table from configuration data. The configuration data
    is expected to be in the format of "1. Configuration: key1:value1 key2:value2 ..." which is
    generated by run_configuration script.
"""
import re
import os
import argparse
